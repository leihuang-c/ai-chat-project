...
public final class ErrCode {
     ...
     * 聊天服务特定错误
     */
    public static final String CHAT_HISTORY_NOT_FOUND = "4100";
    public static final String CHAT_HISTORY_NOT_FOUND_MSG = "问答记录不存在";

    public static final String CHAT_USER_ID_REQUIRED = "4101";
    public static final String CHAT_USER_ID_REQUIRED_MSG = "用户ID不能为空";

    public static final String CHAT_QUESTION_REQUIRED = "4102";
    public static final String CHAT_QUESTION_REQUIRED_MSG = "问题不能为空";

    public static final String CHAT_ANSWER_REQUIRED = "4103";
    public static final String CHAT_ANSWER_REQUIRED_MSG = "回答不能为空";

    public static final String CHAT_SESSION_ID_REQUIRED = "4104";
    public static final String CHAT_SESSION_ID_REQUIRED_MSG = "会话ID不能为空";

    public static final String CHAT_PROCESS_FAILED = "4105";
    public static final String CHAT_PROCESS_FAILED_MSG = "问题处理失败";
    ...
    public static String getErrMsg(String errCode) {
        switch (errCode) {
            ...
            case CHAT_HISTORY_NOT_FOUND:
                return CHAT_HISTORY_NOT_FOUND_MSG;
            case CHAT_USER_ID_REQUIRED:
                return CHAT_USER_ID_REQUIRED_MSG;
            case CHAT_QUESTION_REQUIRED:
                return CHAT_QUESTION_REQUIRED_MSG;
            case CHAT_ANSWER_REQUIRED:
                return CHAT_ANSWER_REQUIRED_MSG;
            case CHAT_SESSION_ID_REQUIRED:
                return CHAT_SESSION_ID_REQUIRED_MSG;
            case CHAT_PROCESS_FAILED:
                return CHAT_PROCESS_FAILED_MSG;
