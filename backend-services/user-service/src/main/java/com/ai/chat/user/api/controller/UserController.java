package com.ai.chat.user.api.controller;
...
import com.ai.chat.user.api.dto.request.LoginRequest;
import com.ai.chat.user.api.dto.request.RegisterRequest;
import com.ai.chat.user.api.dto.request.UpdatePasswordRequest;
import com.ai.chat.user.api.dto.response.LoginResponse;
import com.ai.chat.user.api.dto.response.RegisterResponse;
import com.ai.chat.user.api.dto.response.UpdatePasswordResponse;
import com.ai.chat.user.api.dto.response.UserResponse;
import com.ai.chat.user.application.service.UserService;
...
public class UserController {
    ...
    @io.swagger.v3.oas.annotations.responses.ApiResponses({
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "400", description = "用户名已存在或密码不匹配"),
    ...
    @io.swagger.v3.oas.annotations.responses.ApiResponses({
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "400", description = "旧密码错误或新密码不匹配"),
